...
function Banner(){
    return(
        ...
        <Container  className="text-start d-flex flex-column mt-5 w-100 gap-4 ">
                ...
                <Row><NavLink className="text-decoration-none"><p className="text-white text-decoration-underline fs-5" >Quiero saber más <IoIosArrowRoundForward /></p></NavLink></Row>
